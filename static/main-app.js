...
app.controller("mainCtrl", [
  ...
  function ($scope, $http, $location, dataSvc, $window) {
      ...
      $http.get("/api/teams", window.getAjaxOpts()).then(function (response) {
        if (response != null && response.data != null) {
          ...
          $http
            ...
            .then(function (response) {
              if (response != null && response.data != null) {
                dataSvc.setData($scope.user.accountId);
                for (let team of teamList) {
    ...
    $scope.getmystudents = function () {
      $http.get("/instructor/users").then(function (response) {
        $scope.users = response.data;
      });
    };

    $scope.IsVisible = true;
    $scope.showchallenges = function (data) {
      $scope.userid = data;
    ...
    // Define the onShow function

    $scope.submitchallengesnames = function () {
